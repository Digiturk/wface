...
class MyProfileMenu extends React.Component<
  MyProfileMenuProps & WStore & DispatchProps,
  MyProfileMenuState
> {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        >
          <WChip
            avatar={
              <WAvatar style={{ width: "40px", height: "40px" }}></WAvatar>
            }
            label=""
            clickable
            color="primary"
              ...
              <WMenuItem
                ...
                onClick={(e) => {
                  if (typeof item.onClick === "function") {
                    ...
                    const screenItem = MenuTreeUtil.findByName(
                      this.props.appContext.menuTree,
                      item.onClick
                    );
                    if (!screenItem) {
                      return;
...
const mapDispatchToProps = (dispatch) => ({
  openScreen: (menuTreeItem: IMenuTreeItem, initialValues?: any) =>
...
export default connect<WStore, DispatchProps, MyProfileMenuProps>(
  mapStateToProps,
  mapDispatchToProps
)(MyProfileMenu as any);
