import { IOC, ISearchProvider, WStore, WIcon, WTheme, WCircularProgress } from '../../../';
    ...
    return (
      <div>
        <Select
          ...
          formatOptionLabel={(option, context) => this.searchProvider?.renderSearchItem && this.searchProvider?.renderSearchItem(option)}
...
export default connect<WStore, {}, SearchProps>(mapStateToProps as any)(withTheme((props) => <Search {...props} />) as any);